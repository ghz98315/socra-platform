interface StudyResultSectionDefinition {
  id: string;
  title: string;
  aliases: string[];
}
...
const moduleSectionDefinitions: Record<string, StudyResultSectionDefinition[]> = {
  reading: [
    ...
    { id: 'next-step', title: '下一步', aliases: ['下一步', '下一步先补', '下一步建议'] },
  ],
  foundation: [
    ...
    { id: 'next-time', title: '下次怎么判断', aliases: ['下一次遇到同类题怎么判断', '下次怎么判断', '同类题判断'] },
  ],
  'composition-idea': [
  ...
  'composition-review': [
    { id: 'overall', title: '总体评价', aliases: ['总体评价', '总评', '整体评价'] },
    { id: 'highlights', title: '亮点', aliases: ['亮点', '优点', '可保留的部分'] },
    { id: 'stance-risk', title: '立意与跑题风险', aliases: ['立意与跑题风险', '立意风险', '跑题风险'] },
    { id: 'structure', title: '结构问题', aliases: ['结构问题', '结构', '段落问题'] },
    { id: 'language', title: '语言表达问题', aliases: ['语言表达问题', '表达问题', '语言问题'] },
  ...
  'writing-review': [
    { id: 'overall', title: '总体评价', aliases: ['总体评价', '总评', '整体评价'] },
    { id: 'grammar', title: '语法与拼写问题', aliases: ['语法与拼写问题', '语法问题', '拼写问题'] },
    { id: 'expression', title: '表达升级建议', aliases: ['表达升级建议', '表达建议', '表达升级'] },
    { id: 'flow', title: '结构衔接建议', aliases: ['结构衔接建议', '结构衔接', '结构建议'] },
    { id: 'rewrite', title: '高分句 / 改写示例', aliases: ['可直接替换的高分句', '高分句', '改写示例'] },
    { id: 'checklist', title: '修改清单', aliases: ['下一稿修改清单', '修改清单', '下一稿'] },
  ],
  listening: [
    { id: 'scene', title: '场景与主旨', aliases: ['场景与主旨', '场景', '主旨与场景'] },
    { id: 'signals', title: '关键词与信号词', aliases: ['关键词与信号词', '关键词', '信号词'] },
    { id: 'locate', title: '答案定位', aliases: ['答案定位', '定位答案', '依据定位'] },
    { id: 'mistakes', title: '易错点', aliases: ['易错点', '错因分析', '容易错的地方'] },
    { id: 'relisten', title: '复练重点', aliases: ['该再听哪一部分', '复练建议', '复练重点'] },
    { id: 'next-time', title: '下次怎么更快抓重点', aliases: ['下次怎么更快抓重点', '下次怎么抓重点', '提分建议'] },
  ],
};
