...
export default function BookPage() {
  ...
  return (
    <>
      <SEO 
        title="《从错误开始：一套真正能闭环的学习系统》"
        description="一位工程师爸爸用工厂管理逻辑重建的学习方法。首发特惠套装 ¥39.9，包含电子书（永久买断）与 Socrates 错题系统 1 个月使用权益。"
        type="book"
        canonical="https://socrates.socra.cn/book"
      />
      <div className="py-12 md:py-24 px-4 sm:px-6 max-w-5xl mx-auto">
      <Link to="/" className="inline-flex items-center gap-2 text-sm font-medium text-neutral-500 hover:text-neutral-900 mb-8 md:mb-12 transition-colors">
        ...
        >
          ...
          <div className="bg-white border border-neutral-200 rounded-2xl p-6 sm:p-8 mb-10 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-4" id="preview">
              <Link to="/book-purchase" className="bg-neutral-900 text-white px-8 py-4 rounded-full font-medium text-center hover:bg-neutral-800 transition-colors shadow-lg shadow-neutral-900/20">
                购买「书+工具」套装 (¥39.9)
              </Link>
              <Link to="/read/prologue" className="bg-white border border-neutral-200 text-neutral-900 px-8 py-4 rounded-full font-medium text-center hover:bg-neutral-50 transition-colors">
                开始免费试读
              </Link>
            </div>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-16">
                      ...
                      {part.chapters.map(chapter => {
                        ...
                        return (
                          <div key={chapter.id} className="mb-8 group">
                            <Link to={`/read/${chapter.id}`} className="block">
            ...
            <div className="mt-24 p-8 bg-neutral-50 rounded-2xl text-center border border-neutral-100">
              ...
              <Link to="/book-purchase" className="inline-flex items-center justify-center gap-2 bg-neutral-900 text-white px-8 py-4 rounded-full font-medium hover:bg-neutral-800 transition-colors no-underline shadow-lg shadow-neutral-900/20">
