...
export default function LandingPage() {
  ...
  return (
    <>
      <SEO 
        canonical="https://socrates.socra.cn/"
      />
      {/* --- Hero Section --- */}
      ...
      <section id="articles" className="py-16 md:py-24 px-4 sm:px-6 bg-white border-y border-neutral-200">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link to="/essays" className="hidden sm:flex items-center gap-1 text-sm font-medium text-neutral-900 hover:underline underline-offset-4">
            ...
            {latestArticles.map((article, index) => (
              ...
              >
                ...
                <div className="flex-grow">
                  <Link to={article.slug !== '#' ? `/essays/${article.slug}` : '#'} className="block group-hover:opacity-80 transition-opacity">
                  ...
                  <Link to={article.slug !== '#' ? `/essays/${article.slug}` : '#'} className="inline-flex items-center gap-1 text-sm font-medium text-neutral-900 hover:underline underline-offset-4">
          ...
          <div className="bg-neutral-900 rounded-3xl overflow-hidden flex flex-col lg:flex-row items-center">
            <div className="lg:w-1/2 p-8 md:p-12 lg:p-20 text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link to="/book" className="bg-white text-neutral-900 px-6 py-3 rounded-full font-medium text-center hover:bg-neutral-100 transition-colors whitespace-nowrap">
                  了解详情与购买
                </Link>
                <Link to="/book#preview" className="bg-transparent border border-white/30 text-white px-6 py-3 rounded-full font-medium text-center hover:bg-white/10 transition-colors whitespace-nowrap">
                  免费试读
                </Link>
              </div>
            </div>
