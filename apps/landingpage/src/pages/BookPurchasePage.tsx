...
export default function BookPurchasePage() {
  return (
    <>
      <SEO 
        title="购买《从错误开始》首发套装 | Socrates"
        description="购买《从错误开始》电子书首发特惠套装，包含电子书（永久买断）与 Socrates 错题系统 1 个月使用权益。"
        canonical="https://socrates.socra.cn/book-purchase"
      />
      <div className="py-12 md:py-24 px-4 sm:px-6 max-w-3xl mx-auto">
      <Link to="/book" className="inline-flex items-center gap-2 text-sm font-medium text-neutral-500 hover:text-neutral-900 mb-8 md:mb-12 transition-colors">
