...
// Insert part4Cover before ch11
content = content.replace(/(  \{\s*id:\s*'ch11',)/, part4Cover + "\\n$1");

// Update localStorage key
content = content.replace(/socrates_book_chapters_v8/g, 'socrates_book_chapters_v9');

fs.writeFileSync('src/lib/useBookChapters.ts', content);
console.log('Added part covers and updated storage key.');
